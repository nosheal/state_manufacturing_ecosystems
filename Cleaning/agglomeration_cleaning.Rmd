...
zero_norm <- function(matrix, hhi){ 
  ...
  #Get ratio of industries that have 0 correlation value in them to all industries present in the subset of industries within the geographical radius of the target county. Agglomeration increases as the percent of correlated industries increases. 
  ...
  #Replace these values with a value of 1
  matrix_ratio[zero_inputs] = 1
  
  #Create a final normalizing ratio, that weights the ratio of uncorrelated industries against a measure of industry concentration. Here, as industry concentration rises, that means that the county is dominated by fewer industries. We need to weight the ratio of uncorrelated industries against the level of industry concentration in the county in general. 
