...
state_suppliers_size <- state_entry %>% 
  ggplot(aes(x = manf_emp_share, y = `US Manufacturer`, group = state_abbr, label = state_abbr)) + 
  geom_point(aes(size = tot_emp), alpha = 0.7) + 
  geom_text_repel(aes()) + 
  labs(x = "Manufacturing Share of State Employment, 2019", y = "Total Domestic Mask and Respirator Manufacturers, \nby listed State, 2021") + 
  theme_bw() + 
  guides(size = "none") + 
  axis_theme
...
manf_states <- state_entry %>% 
  ...
  labs(x = "Manufacturing Share of State Establishments, 2019", y = "Confirmed Manufacturing Entrants, by State") + 
  theme_bw() + 
  axis_theme
```
...
manf_share <- state_entry %>% 
  ...
  labs(x = "Manufacturing Share of State Establishments, 2019", y = "Proportion of Suppliers that Manufacturer, \n2021, by State") + 
  theme_bw() + 
  axis_theme
```
